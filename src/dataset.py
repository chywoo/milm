...
class CharTokenizer:
    """Character-level tokenizer with serialization support."""
    ...
    def encode(self, text: str) -> List[int]:
        # Unseen characters fall back to index 0
...
class TextDataset(Dataset):
    """Sequence slicing dataset for autoregressive language model training."""
...
def create_dataloaders(
    ...
    """Create Train/Val DataLoaders and Tokenizer from raw text."""
